...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Transition to a nuclear energy based hydrogen economy in the U.S.}
...
As economies will continue to grow, populations will do so too, and their energy demand will accompany such growth.
Meeting these future needs requires the development of clean energy sources as environmental concerns continue to rise.
As seen in Figure \ref{fig:ghg}, transportation and electricity generation are the economic sectors that produced the most \glspl{GHG} in the \gls{US} in 2017.
As \gls{CO2} is the main component in \glspl{GHG}, decarbonizing transportation and electricity generation will allow us to meet the increases in energy demand and address the environmental concerns at the same time.
...
% word on hydrogen technologies
\glspl{FCEV} are an attractive replacement to the current fossil fuel technologies.
Many countries in Asia, and the European Union are now investing more than $2 billion every year in hydrogen as a promising energy carrier \cite{fuel_cell_and_hydrogen_association_road_2020}.

% word on hydrogen production technologies
